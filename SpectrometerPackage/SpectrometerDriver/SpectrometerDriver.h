...
extern "C" {
  ...
  USBSPECTROMETER_API int stdcall kr_BeginDataAcquisitionF(unsigned int deviceID, unsigned int realTime, unsigned int liveTime, int64_t *ts,double A0, double A1,double A2,char filenName[]);
